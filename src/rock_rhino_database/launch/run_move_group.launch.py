...
def generate_launch_description():
    ...
    webots = WebotsLauncher(world=os.path.join(get_package_share_directory('webots_ros2_universal_robot'), 'worlds', 'panda_fixed.wbt'))
    ...
    panda_controller = ControllerLauncher(
        ...
        arguments=['--webots-robot-name=Panda', '--webots-node-name=panda_arm_controller_1'],
        parameters=[{'synchronization': synchronization, 'controller_name': 'panda_arm_controller'}],
        output='screen'
    )
