...
import rclpy
from rock_rhino_webot_driver.follow_joint_trajectory_client import FollowJointTrajectoryClient



def main(args=None):
    rclpy.init(args=args)
    armed_robot_abb = FollowJointTrajectoryClient('armed_robots_abb', '/abb_arm_controller/follow_joint_trajectory')
