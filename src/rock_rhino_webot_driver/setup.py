...
package_name = 'rock_rhino_webot_driver'
worlds = [
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'armed_robots_ur = rock_rhino_webot_driver.armed_robots_ur:main',
            'armed_robots_abb = rock_rhino_webot_driver.armed_robots_abb:main'
        ],
