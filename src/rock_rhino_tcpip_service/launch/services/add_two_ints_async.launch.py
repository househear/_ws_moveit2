...
def generate_launch_description():
    server = launch_ros.actions.Node(
        package='rock_rhino_tcpip_service', executable='tcpip_service', output='screen')
    client = launch_ros.actions.Node(
        package='rock_rhino_tcpip_service', executable='add_two_ints_client_async', output='screen')
